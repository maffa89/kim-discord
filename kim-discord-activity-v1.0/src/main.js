...
app.innerHTML = `
<main class="shell">
  <header><div class="brand"><img src="/icon128.png"><div><h1>KIM</h1><p id="clock">Norsk tid</p></div></div><span class="live">● LIVE</span></header>
  <section class="hero">
    <div class="portrait"><img id="kimImage" src="/images/kim-state-1.png"><div id="sleep" class="sleep">Zzz</div></div>
  ...
  <section class="states"><img src="/images/kim-state-1.png"><img src="/images/kim-state-2.png"><img src="/images/kim-state-3.png"><img src="/images/kim-state-4.png"><img src="/images/kim-state-5.png"></section>
</main>`;
...
function update(){
  ...
  document.querySelector('#kimImage').src=`/images/kim-state-${d.img}.png`;
...
try { await discordSdk.ready(); } catch(e) { console.info('KIM kjører utenfor Discord preview.', e); }
